...
ALL_BAMBU = {
    ...
    "atax":      {"src": "benchmarks/atax/atax.c",           "top": "atax",      "B": 60},
    "bicg":      {"src": "benchmarks/bicg/bicg.c",           "top": "bicg",      "B": 60},
    "gemm":      {"src": "benchmarks/gemm/gemm.c",           "top": "gemm",      "B": 60},
    "gesummv":   {"src": "benchmarks/gesummv/gesummv.c",     "top": "gesummv",   "B": 60},
}
...
def main():
    ...
    logger = ExperimentLogger("results/rerun/bambu_ablation_extended")
