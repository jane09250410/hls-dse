...
print("SUMMARY")
print("=" * 70)
print(f"Bambu     : FA-DSE overhead {bam_t['algo_total']:.2f}ms | synthesis {bam_t['synthesis']:.0f}ms | ratio 1:{bam_t['synthesis']/bam_t['algo_total']:.0f}")
print(f"Dynamatic : FA-DSE overhead {dyn_t['algo_total']:.2f}ms | synthesis {dyn_t['synthesis']:.0f}ms | ratio 1:{dyn_t['synthesis']/dyn_t['algo_total']:.0f}")
